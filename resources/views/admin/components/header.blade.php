        ...
        <div class="flex items-center justify-between h-12 py-3">
            ...
            <div class="hidden md:flex items-center gap-6">
              @foreach(config('menu.header') as $item)
                ...
                @endforeach
            <button class="text-white block px-6 py-2 mt-2 rounded hover:bg-gray-700">
                <span :class="!notifying ? 'hidden' : 'flex'" class="absolute top-0.5 right-0 z-1 h-2 w-2 rounded-full bg-orange-400 hidden">
